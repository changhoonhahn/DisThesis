...
%\qquad Fiber-fed multi-object spectroscopic surveys, with their ability 
%to collect an unprecedented number of redshifts, currently dominate large-scale structure 
...
%These constraints ultimately lead to significant systematic effects on galaxy clustering measurements. 
%Using simulated mock catalogs of the Sloan Digital Sky Survey Baryon Oscillation Spectroscopic Survey,
%we demonstrate that 
%fiber collisions have a significant impact on the power spectrum monopole and 
%quadrupole that exceeds sample variance at  scales smaller than $k = 0.1-0.2\;h/\mathrm{Mpc}$.
%%investigate the effects of fiber collisions on the galaxy power spectrum monopole and quadrupole and compare methods currently used to correct for fiber collisions in the literature and assess their success in reconstructing the true power spectrum. 
%
%\qquad We present two methods to account for fiber collisions in the power 
%spectrum. The first method statistically reconstructs the clustering of fiber 
%collided galaxy pairs by modeling the distribution of the line-of-sight 
%displacements between them, using cases where both redshifts are obtained. The 
%method also properly accounts for fiber collisions in the shot-noise correction 
%term of the power spectrum estimator. Using this method, we recover the true
%power spectrum monopole of the mock catalogs with residuals of $< 0.5\%$ at 
%$k=0.3\;h/\mathrm{Mpc}$ and $<4\%$ at $k = 0.83 \;h/\mathrm{Mpc}$ -- a 
%significant improvement over existing correction methods. However, the quadrupole does not improve significantly compared to previous methods. 
%
%\qquad The second method models the effect of fiber collisions on the 
%galaxy power spectrum as a convolution with a configuration space 
%two-dimensional top-hat 
%function, which depends on the physical scale of fiber collisions. It directly 
%computes theoretical predictions of the fiber-collided power spectrum multipoles. Using 
%this method, we reliably model the effect of fiber collisions in the monopole and quadrupole down to scales limited by the ability to compute theoretical predictions
%and reduce the influence of smaller scales to a set of nuisance parameters, that can be marginalized over in power spectrum analyses. 
%Therefore,  the methods we present in this paper will allow us 
%to robustly analyze galaxy power spectrum multipole measurements to much smaller scales than previously possible. 
...
\begin{figure}
\begin{center}
\includegraphics[scale=0.425]{mock_catalog_z_dist.pdf} 
...
\begin{figure*}
\begin{center}
\includegraphics[scale=0.55]{mock_catalog_Plk.pdf} 
\caption{
...
\begin{figure*}
\begin{center}
\includegraphics[scale=0.55]{mock_catalog_NN_true_P024k_resid_rebin6x.pdf} 
...
\begin{figure}
\begin{center}
\includegraphics[scale=0.4]{mock_catalog_NN_true_P0k_norm_resid_rebin6x.pdf} 
...
\begin{figure*}
\begin{center}
        \includegraphics[scale=0.575]{mock_catalog_dlos.pdf}
                    \caption{
                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                    \begin{equation} \label{eq:fpeak}
                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                      \begin{equation} \label{eq:integral_shotnoise}
                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                        %It is also worth noting that \cite{Beutler:2014aa} ends up marginalizing over the value of the shot noise in their analysis, thus the impact of this particular choice is not straightforward.
                                                                                                                                                                                                                                                                         ...
                                                                                                                                                                                                                                                                         \begin{figure*}
                                                                                                                                                                                                                                                                         \begin{center}
                                                                                                                                                                                                                                                                         \includegraphics[scale=0.55]{mock_catalog_dlospeak_true_Plk_resid_floran_offset250_0_rebin6x.pdf} 
                                                                                                                                                                                                                                                                         ...
                                                                                                                                                                                                                                                                         \begin{figure}
                                                                                                                                                                                                                                                                         \begin{center}
                                                                                                                                                                                                                                                                         \includegraphics[scale=0.4]{mock_catalog_dlospeak_true_P0k_norm_resid_rebin6x.pdf} 
                                                                                                                                                                                                                                                                         ...
                                                                                                                                                                                                                                                                         \begin{figure*}
                                                                                                                                                                                                                                                                         \begin{center}
                                                                                                                                                                                                                                                                         \includegraphics[scale=0.3]{2pcf_Nseries_upweighted_5mocks_5x5_tophat.pdf} 
                                                                                                                                                                                                                                                                         ...
                                                                                                                                                                                                                                                                         The LOS Reconstruction method corrects for fiber collisions in the observed galaxy positions 
                                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                                          \begin{figure*}
                                                                                                                                                                                                                                                                          \begin{center}
                                                                                                                                                                                                                                                                          \includegraphics[scale=0.5]{mock_catalog_tophatconv_upw_delPlk_rebin6x.pdf}
                                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                                          where $W_\mathrm{2D}(x) \equiv 2 J_1(x)/x$ is the top-hat function in 2D (a cylinder), and 
                                                                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                                                                           \Big(\frac{2l+1}{2}\Big) \int_{\mathrm{max}(-1,-q/k)}^{\mathrm{min}(1,q/k)} d\mu  \, {\cal L}_l(\mu)\, {\cal L}_{l'}(k\mu/q) \nonumber \\ & &
                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                            \begin{figure*}
                                                                                                                                                                                                                                                                            \begin{center}
                                                                                                                                                                                                                                                                            \includegraphics[scale=0.5]{mock_catalog_tophatconv_delPlk_untrusted_18_rebin6x.pdf}
