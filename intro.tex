...
The smaller scale perturbations that enter during the radiation dominated
era \todo{explain the supression}. 
On the other side, the larger scale perturbations that enter during the
matter dominated epoch \todo{explain the lack of suppression}
In practice, this scale dependent evolution of the density fluctuation is 
quantified through the ``transfer function'' $T(k)$. 

After inflation the powerspectrum of the density fluctation is scale-invariant
\beq
P_{inf}(k) \prop k^{n_s}
\eeq
where $n_s \sim 1$ \todo{cite inflation papers}. 
...
%the Hubble radius, the surface at which the recession velocity is equal to the speed of light, will be used to describe \todo{the physical scale of the Universe at different epochs}. 
