...
%By measuring the multipoles of the redshift-space galaxy powerspectrum from galaxy redshift surveys, remarkably, RSDs can be used to measure $f$!
...
Bayes
\eeq
\todo{derive posterior distribution and define likelihoods and etc.}
