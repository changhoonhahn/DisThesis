...
With the above terminology in mind, the evolution of the dark matter overdensity
field can be derived as follows (on sub-horizon scales). For pressureless 
dark matter, we can start from the continuity equation, 
\beq
\eeq
Euler equation, 
\beq
...
\beq
\eeq
(see \todo{cite Dodelson} for detailed derivation). 
