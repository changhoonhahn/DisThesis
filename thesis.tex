% Based on format by José Koiller which was updated by Daniel Foreman-Mackey
...
\newpage %\addcontentsline{toc}{chapter}{List of Appendices}
...
\input{chapters/galaxy}
\input{chapters/galhalo}
